...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Modifier la page</h1>
        <div>
            <a href="{{ route('page', $page->slug) }}" target="_blank" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm mr-2">
                <i class="fas fa-eye fa-sm text-white-50"></i> Voir la page
            </a>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Informations de la page</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.pages.update', $page) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="image">Image d'en-tête</label>
                    @if($page->image)
                        <div class="mb-2">
                            ...
                            <div class="mt-1">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="remove_image">Supprimer cette image</label>
                                </div>
                            </div>
                        </div>
                    @endif
                ...
                <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        ...
                        <label class="custom-control-label" for="is_published">Publier cette page</label>
                    </div>
                </div>
